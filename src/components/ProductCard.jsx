...
const ProductCard = ({ product, onAddToCart }) => {
  const { toggleWishlist, wishlist, formatPrice } = useAuth();
  ...
  return (
    <motion.div 
      className="bg-white rounded-xl overflow-hidden group flex flex-col h-full border border-slate-200 hover:shadow-lg transition-all duration-300 relative"
    >
