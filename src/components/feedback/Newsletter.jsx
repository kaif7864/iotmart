  ...
  return (
    <section className="py-20 bg-card-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-app-bg rounded-sm p-10 md:p-16 border border-border-main flex flex-col items-center text-center">
          ...
          <form className="w-full max-w-md flex flex-col sm:flex-row gap-3" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="flex-grow px-5 py-3 bg-card-bg border border-border-main rounded-sm text-sm text-text-primary focus:border-accent outline-none transition-all"
              required
            />
            <button className="px-8 py-3 bg-accent hover:bg-accent/90 text-white rounded-sm font-bold transition-all flex items-center justify-center gap-2 group whitespace-nowrap shadow-sm">
              Subscribe Now
