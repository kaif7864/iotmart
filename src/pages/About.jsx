...
const About = () => {
  ...
  return (
    <div className="pt-32 pb-32">
      ...
      <section className="bg-slate-50 py-32 border-y border-slate-100 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, i) => {
            ...
            return (
              <div 
                key={feature.title}
                className="glass-card p-10 rounded-2xl border border-border-main text-center hover:shadow-xl transition-all group"
              >
                <div className="w-16 h-16 bg-slate-50 border border-border-main rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:bg-accent group-hover:text-white transition-all">
