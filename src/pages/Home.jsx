        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <Link to="/shop" className="px-10 py-4 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-xl font-bold hover:bg-white/20 transition-all text-sm uppercase tracking-widest text-center">
                Explore More
              </Link>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((cat, i) => (
              <Link to={`/shop?category=${cat.name}`} key={i}>
                <motion.div 
                  whileHover={{ y: -10 }}
                  className="bg-white p-8 rounded-3xl border border-border-main shadow-sm hover:shadow-xl transition-all group cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
              {featuredProducts.reverse().map((product, i) => (
                <div key={product._id} className="relative group">
                  <div className="absolute -top-3 -right-3 z-20 bg-slate-900 text-white px-3 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest flex items-center gap-2 shadow-xl border border-white/20">
