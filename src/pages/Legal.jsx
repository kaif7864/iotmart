  ...
  return (
    <div className="pt-32 pb-32 min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl border border-border-main p-8 md:p-16 shadow-sm">
          <div className="flex justify-between items-center pb-8 border-b border-slate-100 mb-12">
