        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <button 
              ...
              className="py-4 px-8 border-2 border-slate-100 rounded-2xl font-black text-[10px] uppercase tracking-widest text-text-muted hover:text-text-primary hover:border-accent transition-all"
            >
              Continue Sourcing
            </button>
          </div>
    ...
    <div className="pt-32 pb-32 min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-6 mb-12 pb-8 border-b border-border-main">
          <button onClick={() => navigate('/cart')} className="p-3 bg-white border border-border-main rounded-2xl text-text-secondary hover:text-accent transition-all shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <textarea 
                    ...
                    className="w-full px-5 py-4 bg-slate-50 border border-border-main rounded-2xl text-sm font-medium text-text-primary focus:border-accent outline-none transition-all resize-none"
                  ></textarea>
                </div>
              </div>
            </section>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[32px] p-10 border border-border-main sticky top-32 shadow-xl shadow-slate-200/50">
              ...
              <div className="space-y-6 mb-10 max-h-[300px] overflow-y-auto pr-4 custom-scrollbar">
                {cartItems.map(item => (
                  <div key={item._id} className="flex items-center gap-5 group">
                    <div className="w-16 h-16 rounded-xl border border-slate-100 overflow-hidden bg-slate-50 p-2 flex-shrink-0 group-hover:border-accent transition-all">
              ...
              <div className="mb-10 p-6 bg-slate-50 rounded-3xl border border-border-main">
                <p className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] mb-4">Injection Token (Promo)</p>
                <div className="flex gap-2">
                  <input 
                    ...
                    className="flex-grow px-4 py-3 bg-white border border-border-main rounded-xl text-xs font-bold outline-none focus:border-accent"
                  />
                  <button 
                    onClick={handleApplyPromo}
                    className="px-6 py-3 bg-text-primary text-white text-[10px] font-black rounded-xl uppercase tracking-widest hover:bg-accent transition-all"
                  >
                    Apply
                  </button>
                </div>
