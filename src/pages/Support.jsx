    ...
    return (
      <div className="pt-40 pb-24 min-h-screen bg-slate-50 flex items-center justify-center">
        <motion.div 
          ...
          className="max-w-md w-full bg-white p-12 rounded-[40px] text-center shadow-2xl border border-border-main"
        >
          ...
          <p className="text-text-muted text-sm font-medium mb-8">Your support ticket has been encrypted and assigned to a neural link engineer. Reference: <span className="text-accent font-black">#TIC-9942</span></p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="bg-white p-6 rounded-3xl border border-border-main flex items-center gap-4">
                  <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-accent">
            ...
            <div className="p-8 bg-slate-900 rounded-[32px] text-white">
              ...
              <p className="text-xs font-medium text-slate-400 italic">"Our goal is to provide the same level of precision in our support as we do in our hardware modules."</p>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-10 md:p-12 rounded-[40px] shadow-sm border border-border-main">
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-6 py-4 bg-slate-50 border border-transparent rounded-2xl text-sm font-black focus:bg-white focus:border-accent transition-all outline-none"
                    ...
                    <div className="flex gap-4">
                      {['Normal', 'High', 'Critical'].map(p => (
                        <button 
                          ...
                          className={`flex-grow py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${formData.priority === p ? 'bg-slate-900 text-white' : 'bg-slate-50 text-text-muted hover:bg-slate-100'}`}
                        >
                          {p}
                        </button>
                      ))}
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full px-6 py-4 bg-slate-50 border border-transparent rounded-2xl text-sm font-medium focus:bg-white focus:border-accent transition-all outline-none resize-none"
