  ...
  return (
    <div className="pt-32 pb-32 min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl overflow-hidden border border-border-main shadow-sm relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white relative">
              <div className="flex items-center gap-4 mb-6">
                <div className="text-[10px] font-black text-accent uppercase tracking-widest px-3 py-1 bg-accent/5 rounded-lg border border-accent/10">{product.category}</div>
                {product.inStock && (
              ...
              {/* Bulk Pricing */}
              <div className="mb-12 p-6 bg-slate-50 rounded-2xl border border-border-main">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button 
                  ...
                  className={`px-8 py-5 border-2 rounded-2xl transition-all flex items-center justify-center gap-2 font-black text-[10px] uppercase tracking-widest ${
                    isInCompare 
          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="p-6 bg-white rounded-2xl border border-border-main hover:border-accent transition-all cursor-pointer group">
                  <div className="flex justify-between items-start mb-4">
                    <div className="p-2 bg-slate-50 rounded-lg group-hover:bg-accent group-hover:text-white transition-all">
        ...
        <div className="mt-40">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16 border-b border-border-main pb-10">
            ...
            <button 
              ...
              className="px-10 py-4 bg-text-primary text-white text-xs font-black rounded-2xl uppercase tracking-[0.2em] hover:bg-accent transition-all shadow-xl shadow-slate-900/10"
            >
          ...
          <AnimatePresence>
            {showReviewForm && (
              <motion.div 
                ...
                exit={{ opacity: 0, y: -20 }}
                className="mb-16 bg-white border border-border-main rounded-3xl p-10 shadow-sm"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-4">
                    ...
                    <textarea 
                      ...
                      className="w-full px-5 py-4 bg-slate-50 border border-border-main rounded-2xl text-sm outline-none focus:border-accent transition-all"
                    />
                  </div>
                  <div className="space-y-4">
                    <label className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em]">Hardware Photos</label>
                    <div className="border-2 border-dashed border-border-main rounded-2xl h-40 flex flex-col items-center justify-center bg-slate-50 hover:bg-slate-100 transition-all cursor-pointer group">
                ...
                <div className="mt-10 flex justify-end">
                  <button 
                    ...
                    className="px-12 py-4 bg-accent text-white text-[10px] font-black rounded-xl uppercase tracking-[0.2em] hover:bg-accent/90 transition-all shadow-lg"
                  >
                    Publish Audit
                  </button>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8">
              {reviews.map((rev, i) => (
                <motion.div 
                  ...
                  key={i} 
                  className="bg-white border border-border-main rounded-3xl p-10 shadow-sm hover:shadow-md transition-all"
                >
                  <div className="flex justify-between items-start mb-8">
                    <div className="flex items-center gap-5">
                      <div className="w-14 h-14 rounded-2xl bg-accent/10 flex items-center justify-center text-accent font-black text-xl">
                        {rev.user.charAt(0)}
                      </div>
                      <div>
                  ...
                  <div className="flex gap-3">
                    {[1, 2].map(idx => (
                      <div key={idx} className="w-20 h-20 rounded-xl bg-slate-50 border border-border-main flex items-center justify-center">
            ...
            <div className="space-y-8">
              <div className="bg-white border border-border-main rounded-3xl p-10 sticky top-32">
